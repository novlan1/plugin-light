...
const pluginName = 'ManifestExposePlugin';


export class ManifestExposePlugin {
  constructor(options = {}) {
    this.options = {
  ...
  apply(compiler) {
    const [MiniCssExtractPlugin] = compiler.options.plugins.filter(plugin => plugin.constructor.name === 'MiniCssExtractPlugin');
