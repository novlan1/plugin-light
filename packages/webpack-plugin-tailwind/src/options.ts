import { isMp, isQuickapp } from '@plugin-light/shared';
 ...
 */
export const defaultShouldTransformAttribute = (attribute: string) => ['class', 'Class', 'classname', 'className', 'ClassName', 'class-name'].some(item => attribute.endsWith(item));
 ...
 */
export const defaultShouldTransformScript = (fileName: string) => ['pages', 'components', 'layouts'].some(item => fileName.startsWith(item));
